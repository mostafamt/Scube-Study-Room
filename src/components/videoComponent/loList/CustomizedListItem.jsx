...
class CustomizedListItem extends React.Component {
  ...
  if (list)  return list.map((item, index) => (
      <div key={index}>
        <ListItem
          button
          key={item.title}
          onClick={() => this.handleItemClick(index)}
          selected={selectedListIndex === item.title} // To highlight the list head also  ex: Stack, Abstract Data Type
        >
          <ListItemText
            primary={item.title}
                  ...
                  >
                    ...
                    <ListItemText
                      ...
                      onClick={(e) => {
                        ...
                        this.props.selectedListItemIndexChangeHandler(obj.title)
