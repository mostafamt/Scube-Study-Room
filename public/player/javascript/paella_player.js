...
paella.player = null
paella.version = "6.5.0 - build: 17f02538"
...
;(function () {
  ...
  paella.utils.ajax = {
    ...
    assertParams: function assertParams(params) {
      if (!params.url)
        throw new Error("paella.utils.ajax.send: url parameter not found")
  ...
  var AjaxCallback = /*#__PURE__*/ (function (_paella$utils$AsyncLo) {
    ...
    function AjaxCallback(params, type) {
      ...
      else if (_typeof(params) == "object") _this.params = params
      else _this.params = {}
      return _this
    }
        ...
        value: function load(onSuccess, onError) {
          ...
          paella.utils.ajax.send(
            ...
            function (data, type, code, rawData) {
              ...
              if (typeof This.didLoadSuccess == "function")
                status = This.didLoadSuccess(This)
              if (status) onSuccess()
              else onError()
            },
            function (data, type, code, rawData) {
              ...
              This.statusCode = code
              This.rawData = rawData
              if (typeof This.didLoadFail == "function")
                status = This.didLoadFail(This)
              if (status) onSuccess()
              else onError()
            }
          )
  ...
  var AsyncLoader = /*#__PURE__*/ (function () {
    ...
    _createClass(AsyncLoader, [
      ...
      },
      {
        ...
        value: function load(onSuccess, onError) {
          console.warn(
            "paella.utils.AsyncLoader is deprecated. Consider to replace it with JavaScript promises."
          )
          var This = this
  ...
  var Data = /*#__PURE__*/ (function () {
    ...
    function Data(config) {
      ...
      var _loop = function _loop(context) {
        ...
        if (
          !executedCallbacks.some(function (execCallbackData) {
...
paella.addDataDelegate(["default", "trimming"], function () {
  paella.dataDelegates.DefaultDataDelegate = /*#__PURE__*/ (function (
    _paella$DataDelegate
  ) {
    ...
    unset: function unset(key) {
      ...
      if (lastIndex >= 0 && lastIndex + 1 < url.length) {
        ...
        for (var i = 0; i < params.length; ++i) {
          ...
          if (
            (keyValue.length >= 2 && keyValue[0] != key) ||
            keyValue.length < 2
          ) {
  ...
  paella.utils.parameters = {
    ...
    parse: function parse() {
      if (!this.list) {
        ...
        if (
          /(http|https|file)?:\/\/([a-z0-9.\-_\/\~:]*\?)([a-z0-9.\/\-_\%\=\&]*)\#*/i.test(
            url
          )
        ) {
          var params = RegExp.$3
    ...
    toHash: function toHash() {
      ...
      if (parameters.length == 0 || parameters.length == 1) {
        ...
        for (var i = 0; i < parameters.length; ++i) {
          ...
          if (
            keyValue.length >= 2 &&
            paella.utils.hashParams.get(keyValue[0]) == ""
          ) {
...
;(function () {
  ...
  function parseOperatingSystem(userAgentString) {
    ...
    this.system.iPad =
      /iPad/.test(userAgentString) || /FxiOS/.test(userAgentString)
    this.system.iOS =
      this.system.iPhone || this.system.iPad || this.system.iPodTouch
    this.system.Android = /Android/.test(userAgentString)
    this.system.Linux = this.system.Android
      ? false
      : /Linux/.test(userAgentString)
  ...
  function parseBrowser(userAgentString) {
    ...
    this.browser.Chrome =
      /Chrome\/([\d\.]+) Safari\//.test(userAgentString) ||
    ...
    this.browser.Firefox = /Gecko\/[\d\.]+ Firefox\/([\d\.]+)/.test(
      userAgentString
    )
    ...
    var firefoxIOS =
      this.browser.Firefox || /FxiOS\/(\d+\.\d+)/.test(userAgentString)
    ...
    if (this.system.iOS) {
      ...
      this.browser.MobileSafari = /Version\/([\d\.]+) Mobile/.test(
        userAgentString
      )
  ...
  function parseMacOSVersion(userAgentString) {
    var versionString = /Mac OS X (\d+_\d+_*\d*)/.test(userAgentString)
      ? RegExp.$1
      : ""
    ...
    if (versionString != "") {
      ...
      versionString = /Mac OS X (\d+\.\d+\.*\d*)/.test(userAgentString)
        ? RegExp.$1
        : "Unknown"
    ...
    this.system.Version.stringValue =
      this.system.Version.major +
      "." +
      this.system.Version.minor +
      "." +
      this.system.Version.revision
  ...
  function parseWindowsVersion(userAgentString) {
    ...
    if (/NT (\d+)\.(\d*)/.test(userAgentString)) {
      ...
      this.system.Version.stringValue =
        "NT " + this.system.Version.major + "." + this.system.Version.minor
  ...
  function parseIOSVersion(userAgentString) {
    ...
    if (
      /iPhone OS (\d+)_(\d+)_*(\d*)/i.test(userAgentString) ||
      /iPad; CPU OS (\d+)_(\d+)_*(\d*)/i.test(userAgentString)
    ) {
      this.system.Version.major = Number(RegExp.$1)
      this.system.Version.minor = Number(RegExp.$2)
      this.system.Version.revision = RegExp.$3 ? Number(RegExp.$3) : 0
...
paella.utils.folders = {
  get: function get(folder) {
    if (
      ...
      paella.player.config.folders[folder]
    ) {
  ...
  resources: function resources() {
    return (
      paella.baseUrl + (paella.utils.folders.get("resources") || "resources")
    )
  },
...
paella.utils.skin = {
  set: function set(skinName) {
    ...
    paella.utils.styleSheet.add(
      paella.utils.folders.skins() + "/style_" + skinName + ".css"
    )
...
paella.utils.timeParse = {
  ...
  secondsToText: function secondsToText(secAgo) {
    ...
    if (secAgo < 60) {
      return paella.utils.dictionary
    ...
    return paella.utils.dictionary
      .translate("{0} years ago")
      .replace(/\{0\}/g, yearsAgo)
  },
    ...
    _createClass(TimerManager, [
      {
        ...
        value: function setupTimer(timer, time) {
          ...
          timer.jsTimerId = setTimeout(
            "g_timerManager.executeTimerCallback(".concat(this.lastId, ")"),
            time
          )
        },
      },
      {
        ...
        value: function executeTimerCallback(timerId) {
          ...
          if (timer.repeat) {
            timer.jsTimerId = setTimeout(
              "g_timerManager.executeTimerCallback(".concat(timer.timerId, ")"),
              timer.timeout
            )
          }
        },
...
;(function () {
    ...
    _createClass(TabIndexManager, [
      {
        ...
        value: function insertAfter(target, elements) {
          if (target.tabIndex == null || target.tabIndex == -1) {
            throw Error(
              "Insert tab index: the target element does not have a valid tabindex."
            )
          }
          ...
          newTabIndexElements.splice.apply(
            newTabIndexElements,
            [targetIndex + 1, 0].concat(_toConsumableArray(elements))
          )
  ...
  paella.URL = /*#__PURE__*/ (function () {
    ...
    _createClass(PaellaURL, [
      ...
      },
      {
        ...
        get: function get() {
          return (
            new RegExp("^([a-z]+://|//)", "i").test(this._urlText) ||
            /^\//.test(this._urlText)
  ...
  var Log = /*#__PURE__*/ (function () {
    function Log() {
      ...
      logLevelParam = logLevelParam
        ? logLevelParam
        : paella.utils.hashParams.get("logLevel")
    ...
    _createClass(Log, [
      {
        ...
        value: function logMessage(level, message) {
          ...
          if (typeof level == "string") {
            ...
            level >= paella.log.kLevelError &&
            level <= paella.log.kLevelLog
          ) {
            switch (level) {
    ...
    _createClass(DomNode, [
      {
        key: "addNode",
        value: function addNode(childNode) {
          var returnValue = _get(
            _getPrototypeOf(DomNode.prototype),
            "addNode",
            this
          ).call(this, childNode)
      ...
      },
      {
        ...
        value: function removeNode(childNode) {
          if (
            _get(_getPrototypeOf(DomNode.prototype), "removeNode", this).call(
              this,
              childNode
            )
          ) {
...
;(function () {
  ...
  function showBackground(bkgData) {
    ...
    var style = {
      backgroundImage: "url("
        .concat(paella.baseUrl)
        .concat(paella.utils.folders.get("resources"), "/style/")
        .concat(bkgData.content, ")"),
    ...
    this.container.addNode(
      new paella.DomNode("div", "videoContainerBackground", style)
    )
  }
  ...
  function hideAllLogos() {
    ...
    for (var i = 0; i < this.logos.length; ++i) {
      var logoId = this.logos[i].content.replace(/\./gi, "-")
  ...
  function showLogos(logos) {
    ...
    for (var i = 0; i < logos.length; ++i) {
      var logo = logos[i]
      var logoId = logo.content.replace(/\./gi, "-")
      var logoNode = this.container.getNode(logoId)
      var rect = logo.rect

      if (!logoNode) {
        style = {}
        logoNode = this.container.addNode(
          new paella.DomNode("img", logoId, style)
        )
        logoNode.domElement.setAttribute(
          "src",
          ""
            .concat(paella.baseUrl)
            .concat(paella.utils.folders.get("resources"), "/style/")
  ...
  function showButtons(buttons, profileData) {
    ...
    if (buttons) {
      ...
      buttons.forEach(function (btn, index) {
        ...
        var logoNode = _this10.container.addNode(
          new paella.DomNode("div", btn.id, style)
        )
  ...
  function getClosestRect(profileData, videoDimensions) {
    ...
    var videoAspectRatio =
      videoDimensions.h == 0 ? 1.777777 : videoDimensions.w / videoDimensions.h
  ...
  function applyProfileWithJson(profileData, animate) {
    ...
    var getProfile = function getProfile(content) {
      var result = null
      profileData &&
        profileData.videos.some(function (videoProfile) {
    ...
    var applyVideoRect = function applyVideoRect(
      profile,
      videoData,
      videoWrapper,
      player
      ...
      if (frameStrategy) {
        ...
        var isMainAudioPlayer =
          paella.player.videoContainer.streamProvider.mainAudioPlayer == player
        visible
          ? player.enable(isMainAudioPlayer)
          : player.disable(isMainAudioPlayer)
      }
    }
    ...
    function Profiles() {
      ...
      paella.events.bind(paella.events.profileListChanged, function () {
        if (
          ...
          (!_this12.currentProfile ||
            _this12.currentProfileName != _this12.currentProfile.id)
        ) {
        ...
        value: function setProfile(profileName, animate) {
          ...
          if (!paella.player.videoContainer.ready) {
            ...
            var profileData =
              ...
              (g_profiles.length > 0 && g_profiles[0])
            ...
            if (!profileData && g_profiles.length == 0) {
              if (profileReloadCount < maxProfileReloadCunt) {
                ...
                console.error(
                  "No valid video layout profiles were found. Check that the 'content' attribute setting in 'videoSets', at config.json file, matches the 'content' property in the video manifest."
                )
                return false
              }
            } else {
              this._currentProfileName = profileName
              applyProfileWithJson.apply(paella.player.videoContainer, [
                profileData,
                animate,
              ])
              return true
...
;(function () {
  ...
  var BestFitVideoQualityStrategy = /*#__PURE__*/ (function (
    _paella$VideoQualityS
  ) {
        ...
        value: function getQualityIndex(source) {
          ...
          if (source.length > 0) {
            ...
            if (selected.res && selected.res.w && selected.res.h) {
              var selected_res =
                parseInt(selected.res.w) * parseInt(selected.res.h)
              ...
              for (var i = 0; i < source.length; ++i) {
                ...
                if (res) {
                  var m_res =
                    parseInt(source[i].res.w) * parseInt(source[i].res.h)
  ...
  var LimitedBestFitVideoQualityStrategy = /*#__PURE__*/ (function (
    _paella$VideoQualityS2
  ) {
  ...
  paella.videoFactory = {
    ...
    getVideoObject: function getVideoObject(id, streamData, rect) {
      ...
      if (
        this._factoryList.some(function (factory) {
...
;(function () {
  ...
  var MultiformatAudioElement = /*#__PURE__*/ (function (
    _paella$AudioElementB
  ) {
...
;(function () {
  ...
  var VideoRect = /*#__PURE__*/ (function (_paella$DomNode3) {
    ...
    function VideoRect(id, domType, left, top, width, height) {
      ...
      var zoomEnabled =
        (zoomSettings.enabled !== undefined ? zoomSettings.enabled : true) &&
        _this26.allowZoom()
      ...
      if (zoomEnabled) {
        ...
        var wheelDelta = function wheelDelta(evt) {
          var wheel =
            evt.originalEvent.deltaY * (paella.utils.userAgent.Firefox ? 2 : 1)
          var maxWheel = 6
          return -Math.abs(wheel) < maxWheel
            ? wheel
            : maxWheel * Math.sign(wheel)
        }
        ...
        var clearAltScrollMessage = function clearAltScrollMessage() {
          var animate =
            arguments.length > 0 && arguments[0] !== undefined
              ...
              : true
          animate
            ? $(altScrollMessageContainer).animate({
                opacity: 0.0,
              })
        ...
        $(eventCapture).on("touchmove", function (evt) {
          ...
          if (curTouches.length > 1 && touches.length > 1) {
            ...
            _this26._zoom =
              _this26._zoom > _this26._maxZoom
                ? _this26._maxZoom
                : _this26._zoom
            var newVideoSize = {
        ...
        _this26.zoomIn = function () {
          if (_this26._zoom >= _this26._maxZoom || !_this26._zoomAvailable)
            return
          ...
          _this26._zoom = _this26._zoom < 100 ? 100 : _this26._zoom
          _this26._zoom =
            _this26._zoom > _this26._maxZoom ? _this26._maxZoom : _this26._zoom
          var newVideoSize = {
            w: $(_this26.domElement).width(),
            h: $(_this26.domElement).height(),
          }
        ...
        altScrollMessageContainer.innerHTML =
          "<p>" +
          paella.utils.dictionary.translate(
            "Use Alt+Scroll to zoom the video"
          ) +
          "</p>"
    ...
    _createClass(VideoRect, [
      ...
      },
      {
        ...
        get: function get() {
          var canvasType =
            this._stream &&
            Array.isArray(this._stream.canvas) &&
            this._stream.canvas[0]

          var canvasData = (canvasType &&
            paella.getVideoCanvasData(this._stream.canvas[0])) || {
  ...
  var VideoElementBase = /*#__PURE__*/ (function (_paella$VideoRect) {
    ...
    function VideoElementBase(
      ...
      if (_this27._stream.preview)
        _this27.setPosterFrame(_this27._stream.preview)
    ...
    _createClass(VideoElementBase, [
      ...
      },
      {
        ...
        value: function videoCanvas() {
          return Promise.reject(
            new Error(
              "VideoElementBase::videoCanvas(): Not implemented in child class."
            )
          )
    ...
    _createClass(Html5Video, [
      {
        ...
        value: function _configureVideoEvents(videoElement) {
          ...
          $(this.video).bind("emptied", function (evt) {
            if (
              _this29._resumeCurrentTime &&
              !isNaN(_this29._resumeCurrentTime)
            ) {
      ...
      },
      {
        ...
        value: function load() {
          ...
          return new Promise(function (resolve, reject) {
            ...
            if (
              _this33._currentQuality === null &&
              _this33._videoQualityStrategy
            ) {
              _this33._currentQuality =
                _this33._videoQualityStrategy.getQualityIndex(sources)
            }

            var stream =
              _this33._currentQuality < sources.length
                ? sources[_this33._currentQuality]
                : null
            _this33.video.innerText = ""

            _this33
              .videoCanvas()
              .then(function (CanvasClass) {
                ...
                if (
                  window.$paella_bg &&
                  bg.app &&
                  canvasInstance instanceof bg.app.WindowController
                ) {
                  // WebGL canvas
              ...
              .then(function (canvas) {
                if (
                  canvas &&
                  paella.WebGLCanvas &&
                  canvas instanceof paella.WebGLCanvas
                ) {
      ...
      },
      {
        ...
        value: function getCurrentQuality() {
          ...
          return new Promise(function (resolve) {
            resolve(
              _this36._getQualityObject(
                _this36._currentQuality,
                _this36._stream.sources[_this36._streamName][
                  _this36._currentQuality
                ]
              )
            )
      ...
      },
      {
        ...
        value: function setCurrentTime(time) {
          ...
          return this._deferredAction(function () {
            ;(time == 0 || time) &&
              !isNaN(time) &&
              (_this41.video.currentTime = time)
          })
        },
      },
      {
        ...
        value: function freeze() {
          ...
          return this._deferredAction(function () {
            ...
            ctx.drawImage(
              ...
              0,
              0,
              Math.ceil(canvas.width / 16) * 16,
              Math.ceil(canvas.height / 16) * 16
            ) //Draw image
    ...
    _createClass(ImageVideo, [
      ...
      },
      {
        ...
        value: function _getQualityObject(index, s) {
          return {
            ...
            compare: function compare(q2) {
              return (
                Number(this.res.w) * Number(this.res.h) -
                Number(q2.res.w) * Number(q2.res.h)
              )
            },
          }
        },
        ...
        value: function getVideoData() {
          ...
          return new Promise(function (resolve) {
            _this51._deferredAction(function () {
              var imgStream =
                _this51._stream.sources.image[_this51._currentQuality]
              var videoData = {
        ...
        value: function load() {
          ...
          if (this._currentQuality === null && this._videoQualityStrategy) {
            this._currentQuality =
              this._videoQualityStrategy.getQualityIndex(sources)
          }

          var stream =
            this._currentQuality < sources.length
              ? sources[this._currentQuality]
              : null
      ...
      },
      {
        ...
        value: function getCurrentQuality() {
          ...
          return new Promise(function (resolve) {
            resolve(
              _this54._getQualityObject(
                _this54._currentQuality,
                _this54._stream.sources.image[_this54._currentQuality]
              )
            )
          })
        },
...
;(function () {
    ...
    _createClass(VideoOverlay, [
      ...
      },
      {
        ...
        value: function getLayer(id, zindex) {
          ...
          return (
            $(this.domElement).find("#" + id)[0] || this.addLayer(id, zindex)
          )
        },
      },
      {
      ...
      $(_this66.domElement).click(function (evt) {
        var doClick = function doClick() {
          ...
          paella.player.videoContainer.paused().then(function (paused) {
            ...
            if (
              _this66.firstClick &&
              _this66.streamProvider.videoPlayers.some(function (p) {
    ...
    _createClass(VideoContainerBase, [
          ...
          return new Promise(function (resolve, reject) {
            ...
            paella.player.videoContainer
              ...
              .then(function (duration) {
                if (
                  _this69._seekTimeLimit > 0 &&
                  _this69._seekType == paella.SeekType.BACKWARDS_ONLY
                ) {
                ...
                _this69
                  .setCurrentPercent(newPositionPercent)
        ...
        value: function seekToTime(time) {
          ...
          return new Promise(function (resolve, reject) {
            paella.player.videoContainer
              ...
              .then(function (currentTime) {
                if (
                  _this70._seekTimeLimit &&
                  _this70._seekType == paella.SeekType.BACKWARDS_ONLY
                ) {
      ...
      },
      {
        ...
        value: (function (_onresize) {
          ...
          _get(
            _getPrototypeOf(VideoContainerBase.prototype),
            "onresize",
            this
          ).call(this, onresize)
        }),
      ...
      },
      {
        ...
        set: function set(att) {
          ...
          Array.from(
            paella.player.videoContainer.container.domElement.children
          ).forEach(function (ch) {
  ...
  var LimitedSizeProfileFrameStrategy = /*#__PURE__*/ (function (
    _ProfileFrameStrategy
  ) {
    ...
    _createClass(LimitedSizeProfileFrameStrategy, [
      {
        ...
        value: function adaptFrame(videoDimensions, frameRect) {
          if (
            videoDimensions.width < frameRect.width ||
            videoDimensions.height < frameRect.height
          ) {
  ...
  var StreamProvider = /*#__PURE__*/ (function () {
    function StreamProvider(videoData) {
      ...
      this._players = []
      this._autoplay =
        paella.utils.parameters.get("autoplay") == "true" ||
    ...
    _createClass(StreamProvider, [
      {
        ...
        value: function init(videoData) {
          ...
          if (
            !this._videoData.some(function (stream) {
          ...
          this._videoStreams.forEach(function (videoStream, index) {
            ...
            var player = paella.videoFactory.getVideoObject(
              "video_".concat(index),
              videoStream,
              rect
            )
          ...
          this._audioStreams.forEach(function (audioStream, index) {
            var player = paella.audioFactory.getAudioObject(
              "audio_".concat(index),
              audioStream
            )
            player.setAutoplay(autoplay)
          ...
          var sync = function sync() {
            _this79._syncProviderPlayer.currentTime().then(function (t) {
              _this79.players.forEach(function (player) {
                if (
                  player != syncProviderPlayer &&
                  player.currentTimeSync != null &&
                  Math.abs(player.currentTimeSync - t) > maxDiff
                ) {
                  console.debug(
                    "Sync player current time: "
                      .concat(player.currentTimeSync, " to time ")
                      .concat(t)
                  )
  ...
  var VideoContainer = /*#__PURE__*/ (function (_paella$VideoContaine) {
    ...
    function VideoContainer(id) {
      ...
      _this81._container = new paella.DomNode(
        "div",
      ...
      _this81._audioTag =
        ...
        paella.player.config.player.defaultAudioTag ||
        paella.utils.dictionary.currentLanguage()
      _this81._audioPlayer = null // Initial volume level

      _this81._volume = paella.utils.cookies.get("volume")
        ? Number(paella.utils.cookies.get("volume"))
        : 1
    ...
    _createClass(VideoContainer, [
        ...
        value: function play() {
          ...
          return new Promise(function (resolve, reject) {
            _this82
              ...
              .then(function () {
                _get(
                  _getPrototypeOf(VideoContainer.prototype),
                  "play",
                  _this82
                ).call(_this82)
      ...
      },
      {
        ...
        value: function pause() {
          ...
          return new Promise(function (resolve, reject) {
            _this83.streamProvider
              .callPlayerFunction("pause")
              .then(function () {
                _get(
                  _getPrototypeOf(VideoContainer.prototype),
                  "pause",
          ...
          return new Promise(function (resolve, reject) {
            _this84
              ...
              .then(function (trimmingData) {
                ...
                return _this84.streamProvider.callPlayerFunction(
                  "setCurrentTime",
                  time
                )
              })
      ...
      },
      {
        ...
        value: function setVolume(params) {
          ...
          if (_typeof(params) == "object") {
            console.warn(
              "videoContainer.setVolume(): set parameter as object is deprecated"
            )
            return Promise.resolve()
          } else if (params == 0) {
            return this.mute()
      ...
      },
      {
        ...
        value: function getVideoRect(videoIndex) {
          if (this.videoWrappers.length > videoIndex) {
            ...
            throw new Error(
              "Video wrapper with index ".concat(videoIndex, " not found")
            )
          }
        },
      },
      {
        ...
        value: function setStreamData(videoData) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            if (
              streamDataAudioTag != _this92._audioTag &&
              streamDataAudioTag != null
            ) {
              _this92._audioTag = streamDataAudioTag
            }

            _this92.streamProvider.videoPlayers.forEach(function (
              player,
              index
            ) {
              addVideoWrapper.apply(_this92, [
            ...
            _this92.streamProvider
              ...
              .then(function () {
                ...
                var eventBindingObject =
                  _this92.masterVideo().video || _this92.masterVideo().audio
                ...
                var profileToUse =
                  paella.utils.parameters.get("profile") ||
      ...
      },
      {
        ...
        value: function resizePortrait() {
          var width =
            paella.player.isFullScreen() == true
              ? $(window).width()
...
;(function () {
  var PluginManager = /*#__PURE__*/ (function () {
    ...
    function PluginManager() {
      ...
      var timer = new paella.utils.Timer(function () {
        if (paella.player && paella.player.controls && _this94.doResize)
    ...
    _createClass(PluginManager, [
          ...
          if (pluginBaseClass != undefined) {
            ...
            this.foreach(function (plugin, config) {
              ...
              if (eval("plugin instanceof " + pluginBaseClass)) {
                if (config.enabled) {
                  paella.log.debug(
                    "Load plugin (" + pluginBaseClass + "): " + plugin.getName()
                  )
      ...
      },
      {
        ...
        value: function foreach(callback) {
          ...
          try {
            enablePluginsByDefault =
              paella.player.config.plugins.enablePluginsByDefault
          } catch (e) {}
  ...
  function _hideContainer(identifier, container, swapFocus) {
    ...
    if (
      container.plugin.getButtonType() == paella.ButtonPlugin.type.menuButton
    ) {
    ...
    container.button.className = container.button.className.replace(
      " selected",
      ""
    )
  ...
  var PopUpContainer = /*#__PURE__*/ (function (_paella$DomNode8) {
    ...
    _createClass(PopUpContainer, [
      ...
      },
      {
        ...
        value: function showContainer(identifier, button) {
          ...
          if (
            ...
            _hideContainer.apply(this, [
              this.currentContainerId,
              prevContainer,
              swapFocus,
            ])

            _showContainer.apply(this, [
              identifier,
              container,
              button,
              swapFocus,
      ...
      },
      {
        ...
        value: function registerContainer(
          identifier,
          domElement,
          button,
          plugin
          ...
          $(button).click(function (event) {
            if (!this.plugin.isPopUpOpen()) {
              paella.player.controls
                .playbackControl()
                .showPopUp(this.popUpIdentifier, this, false)
            } else {
              paella.player.controls
                .playbackControl()
                .hidePopUp(this.popUpIdentifier, this, false)
            }
          })
          $(button).keypress(function (event) {
            if (event.keyCode == 13 && !this.plugin.isPopUpOpen()) {
              if (this.plugin.isPopUpOpen()) {
                paella.player.controls
                  .playbackControl()
                  .hidePopUp(this.popUpIdentifier, this, true)
              } else {
                paella.player.controls
                  .playbackControl()
                  .showPopUp(this.popUpIdentifier, this, true)
              }
      ...
      },
      {
        ...
        value: function showContainer(identifier, button) {
          ...
          if (
            ...
            var prevContainer = this.containers[this.currentContainerId]
            prevContainer.button.className =
              prevContainer.button.className.replace(" selected", "")
            container.button.className =
              container.button.className + " selected"
            paella.events.trigger(paella.events.hidePopUp, {
    ...
    _createClass(UIPlugin, [
      {
        ...
        value: function checkVisibility() {
          var modes = this.config.visibleOn || [
      ...
      [
        ...
        },
        {
          ...
          value: function setText(text) {
            this.container.innerHTML =
              ...
              paella.AntiXSS.htmlEscape(text) +
              "</span>"
        ...
        },
        {
          ...
          value: function getContainerClassName() {
            if (
              this.getButtonType() == paella.ButtonPlugin.type.timeLineButton
            ) {
              return (
                paella.ButtonPlugin.kTimeLineClassName +
                " " +
                this.getSubclass()
              )
            } else if (
              ...
              this.getButtonType() == paella.ButtonPlugin.type.menuButton
            ) {
              return (
                paella.ButtonPlugin.kPopUpClassName +
                " menuContainer " +
                this.getSubclass()
              )
            }
          ...
          value: function rebuildMenu() {
            ...
            function getButtonItem(itemData, plugin) {
              ...
              $(elem).keyup(function (event) {
                if (event.keyCode == 27) {
                  paella.player.controls.hidePopUp(
                    this.data.plugin.getName(),
                    null,
                    true
                  )
                }
      ...
      [
        {
          ...
          value: function BuildPluginButton(plugin, id) {
            ...
            var ariaLabel =
              plugin.getAriaLabel() ||
              paella.utils.dictionary.translate(plugin.config.ariaLabel) ||
              ""
            ...
            function onAction(self) {
              paella.userTracking.log(
                "paella:button:action",
                self.plugin.getName()
              )
  ...
  var VideoOverlayButtonPlugin = /*#__PURE__*/ (function (
    _paella$ButtonPlugin
  ) {
...
;(function () {
        ...
        _createClass(WebGLCanvas, [
          ...
          },
          {
            ...
            value: function buildVideoSurface(sceneRoot, videoTexture) {
              ...
              sphereNode.addComponent(
                new bg.scene.Transform(bg.Matrix4.Scale(1, -1, 1))
              )
  ...
  paella.addCanvasPlugin = function (
    canvasType,
    webglSupport,
    mouseEventsSupport,
    canvasPluginCallback
  ) {
  ...
  function loadWebGLDeps() {
    return new Promise(function (resolve) {
      if (!window.$paella_bg) {
        paella
          .require("".concat(paella.baseUrl, "javascript/bg2e-es2015.js"))
          .then(function () {
            window.$paella_bg = bg
    ...
    _createClass(CaptionParserManager, [
      {
        ...
        value: function addPlugin(plugin) {
          ...
          if (
            ((Array.isArray && Array.isArray(ext)) || ext instanceof Array) ==
            false
          ) {
            ext = [ext]
          }
          ...
          if (ext.length == 0) {
            paella.log.debug(
              "No extension provided by the plugin " + plugin.getName()
            )
          } else {
  ...
  paella.captions = {
    ...
    search: function search(text, next) {
      ...
      this.getAvailableLangs().forEach(function (l) {
        asyncLoader.addCallback(
          new SearchCallback(self.getCaptions(l.id), text)
        )
      })
      asyncLoader.load(
        function () {
            ...
            .then(function (dataRaw) {
              ...
              if (parser == undefined) {
                ...
                if (!paella.player.videoContainer) {
                  paella.log.debug(
                    "Video container is not ready, delaying parse until next reload"
                  )
                  return
                }
                    ...
                    self._captions = [
                      {
                        ...
                        content: paella.utils.dictionary.translate(
          ...
          if (this._index == undefined) {
            ...
            paella.player.videoContainer.trimming().then(function (trimming) {
              _this108._index.search(txt).forEach(function (s) {
                ...
                if (
                  trimming.enabled &&
                  (c.end < trimming.start || c.begin > trimming.end)
                ) {
                  return
                }
...
;(function () {
    ...
    _createClass(TimeControl, [
      {
        ...
        value: function onTimeUpdate(memo) {
          this.domElement.innerText = this.secondsToHours(
            parseInt(memo.currentTime)
          )
        },
      },
      {
            ...
            .then(function (trimming) {
              ...
              var videoData = {
                ...
                trimming: {
                  ...
                  duration: trimming.enabled
                    ? trimming.end - trimming.start
                    : duration,
                },
              }
        ...
        get: function get() {
          ...
          if (!this._canvas) {
            var createCanvas = function createCanvas(index) {
              ...
              result.className =
                "playerContainer_controls_playback_playbackBar_canvas layer_" +
                index
              result.id =
                "playerContainer_controls_playback_playbackBar_canvas_" + index
  ...
  var PlaybackBar = /*#__PURE__*/ (function (_paella$DomNode10) {
    ...
    function PlaybackBar(id) {
      ...
      _this116.domElement.addEventListener(
        "touchstart",
        function (event) {
          paella.utils.mouseManager.down(thisClass, event)
          event.stopPropagation()
      ...
      paella.events.bind(
        paella.events.seekAvailabilityChanged,
        function (e, data) {
        ...
        value: function movePassive(event) {
          ...
          function updateTimePreview(duration, trimming) {
            ...
            if (This._hasSlides) {
              ...
              if (
                clientX > ancho / 2 + pos.left &&
                clientX < pos.left + width - ancho / 2
              ) {
                // LEFT
            ...
            if (
              clientX > ancho2 / 2 + pos.left &&
              clientX < pos.left + width - ancho2 / 2
            ) {
              $("#divTimeOverlay").css("left", posx2) // CENTER THE DIV HOVER THE MOUSE
            } else if (clientX < width / 2)
              $("#divTimeOverlay").css("left", pos.left)
            else $("#divTimeOverlay").css("left", pos.left + width - ancho2 - 2)
  ...
  var PlaybackControl = /*#__PURE__*/ (function (_paella$DomNode11) {
        ...
        value: function addPlugin(plugin) {
          ...
          plugin.checkEnabled(function (isEnabled) {
            ...
            if (isEnabled) {
              ...
              if (
                plugin.getButtonType() == paella.ButtonPlugin.type.popUpButton
              ) {
                parent = _this119.popUpPluginContainer.domElement
                var popUpContent = paella.ButtonPlugin.BuildPluginPopUp(
                  parent,
                  plugin,
                  id + "_container"
                )

                _this119.popUpPluginContainer.registerContainer(
                  plugin.getName(),
                  popUpContent,
                  button,
                  plugin
                ...
                plugin.getButtonType() ==
                paella.ButtonPlugin.type.timeLineButton
              ) {
                parent = _this119.timeLinePluginContainer.domElement
                var timeLineContent = paella.ButtonPlugin.BuildPluginPopUp(
                  parent,
                  plugin,
                  id + "_timeline"
                )

                _this119.timeLinePluginContainer.registerContainer(
                  plugin.getName(),
                  timeLineContent,
                  button,
                  plugin
                ...
                plugin.getButtonType() == paella.ButtonPlugin.type.menuButton
              ) {
                parent = _this119.popUpPluginContainer.domElement
                var popUpContent = paella.ButtonPlugin.BuildPluginMenu(
                  parent,
                  plugin,
                  id + "_container"
                )
    ...
    function PlaybackControl(id) {
      ...
      _this118.pluginsContainer = new paella.DomNode(
        "div",
        id + "_playbackBarPlugins"
      )
    ...
    _createClass(PlaybackControl, [
      {
        ...
        value: function showPopUp(identifier, button) {
          ...
          this.timeLinePluginContainer.showContainer(
            identifier,
            button,
            swapFocus
          )
          this.hideCrossTimelinePopupButtons(
            identifier,
            this.popUpPluginContainer,
            this.timeLinePluginContainer,
            button,
            swapFocus
          )
      ...
      },
      {
        ...
        value: function hideCrossTimelinePopupButtons(
          identifier,
          popupContainer,
          timelineContainer,
          button
      ...
      },
      {
        ...
        value: function hidePopUp(identifier, button) {
          ...
          this.timeLinePluginContainer.hideContainer(
            identifier,
            button,
            swapFocus
          )
        ...
        get: function get() {
          if (!this._popUpPluginContainer) {
            this._popUpPluginContainer = new paella.PopUpContainer(
              this.identifier + "_popUpPluginContainer",
        ...
        get: function get() {
          if (!this._timeLinePluginContainer) {
            this._timeLinePluginContainer = new paella.TimelineContainer(
              this.identifier + "_timelinePluginContainer",
  ...
  var ControlsContainer = /*#__PURE__*/ (function (_paella$DomNode12) {
    ...
    function ControlsContainer(id) {
      ...
      _this120.videoOverlayButtons = new paella.DomNode(
        "div",
        id + "_videoOverlayButtonPlugins"
      )
      _this120.videoOverlayButtons.domElement.className =
      ...
      paella.pluginManager.setTarget(
        "videoOverlayButton",
        _assertThisInitialized(_this120)
      )
      return _this120
    }
    ...
    _createClass(ControlsContainer, [
      ...
      },
      {
        ...
        value: function hide() {
          ...
          if (this._doHide) {
            if (
              !paella.utils.userAgent.browser.IsMobileVersion &&
              !paella.utils.userAgent.browser.Explorer
            ) {
              $(this.domElement).animate(
                {
                  opacity: 0.0,
...
;(function () {
  var LoaderContainer = /*#__PURE__*/ (function (_paella$DomNode13) {
    ...
    function LoaderContainer(id) {
      ...
      _this123.loader = _this123.addNode(
      ...
      _this123.timer = new paella.utils.Timer(function (timer) {
        ...
        _this123.loader.domElement.style.transform = "rotate(".concat(
          _this123.loaderPosition,
          "deg"
        )
    ...
    _createClass(KeyManager, [
      {
        ...
        value: function addPlugin(plugin) {
          ...
          if (
            plugin.checkEnabled(function (e) {
      ...
      },
      {
        ...
        value: function userData() {
          return paella_DeferredResolved({
            ...
            name: "Anonymous",
            avatar:
              paella.utils.folders.resources() + "/images/default_avatar.png",
            isAnonymous: true,
          })
        },
      },
  ...
  var PlayerBase = /*#__PURE__*/ (function () {
    _createClass(PlayerBase, [
      {
        ...
        value: function checkCompatibility() {
          ...
          var isCompatible =
            ...
            (paella.utils.userAgent.browser.Explorer &&
              paella.utils.userAgent.browser.Version.major >= 9)

          if (isCompatible) {
            return true
          } else {
            var errorMessage = paella.utils.dictionary.translate(
            ...
            message +=
              ...
              paella.utils.dictionary.translate("Continue anyway") +
              "</a></div>"
    ...
    _createClass(PlayerBase, [
      ...
      },
      {
        ...
        get: function get() {
          return (
            paella.player.videoLoader._url ||
            (paella.player.config.standalone &&
              paella.player.config.standalone.repository)
          )
        },
      },
      {
        ...
        value: function loadDictionary() {
          ...
          return new Promise(function (resolve) {
            paella.utils.ajax.get(
              {
                url:
                  _this126.initParams.dictionaryUrl +
                  "_" +
                  paella.utils.dictionary.currentLanguage() +
                  ".json",
              },
      ...
      },
      {
        ...
        value: function loadConfig() {
          ...
          var loadAccessControl = function loadAccessControl(data) {
            var AccessControlClass = paella.utils.objectFromString(
              data.player.accessControlClass || "paella.AccessControl"
            )
          ...
          if (this.initParams.config) {
            ...
            return new Promise(function (resolve, reject) {
              _this127.initParams
                .loadConfig(_this127.initParams.configUrl)
                .then(function (data) {
    ...
    _createClass(PaellaPlayer, [
          ...
          if (this.videoIdentifier) {
            if (this.mainContainer) {
              ...
              var videoQualityStrategy =
                new paella.BestFitVideoQualityStrategy()
              ...
              if (canRead) {
                ...
                if (redirectUrl) {
                  message +=
                    ...
                    redirectUrl +
                    '">' +
                    paella.utils.dictionary.translate("Login") +
                    "</a></div>"
                }
              ...
              This.videoContainer
                ...
                .then(function () {
                  ...
                  if (
                    ...
                    g_lazyLoadInstance != null
                  ) {
                    This.play()
                  } else if (loader.metadata.preview) {
                    This.lazyLoadContainer = new LazyThumbnailContainer(
                      loader.metadata.preview
                    )
                ...
                ["catch"](function (error) {
                  ...
                  paella.messageBox.showError(
                    paella.utils.dictionary.translate(msg)
                  )
                })
            })
          }
      ...
      },
      {
        ...
        value: function isLiveStream() {
          ...
          return (
            checkSource(loader.streams, 0) || checkSource(loader.streams, 1)
          )
        },
      },
      {
        ...
        value: function loadPreviews() {
          ...
          if (masterPreviewImg) {
            var masterRect =
              paella.player.videoContainer.overlayContainer.getVideoRect(0)
          ...
          if (slavePreviewImg) {
            var slaveRect =
              paella.player.videoContainer.overlayContainer.getVideoRect(1)
          ...
          if (this.videoIdentifier) {
            ...
            loader.loadVideo(function () {
              if (!loader.metadata.preview) {
                ...
                _this133.lazyLoadContainer = new LazyThumbnailContainer(
                  loader.metadata.preview
                )
...
;(function () {
    ...
    _createClass(DefaultVideoLoader, [
            ...
            paella.utils.ajax.get(
              ...
              function (data, type, err) {
                switch (err) {
                  case 401:
                    paella.messageBox.showError(
                      paella.utils.dictionary.translate("You are not logged in")
                    )
                    break
        ...
        value: function loadFrameData(data) {
          ...
          if (data.frameList && data.frameList.forEach) {
            ...
            data.frameList.forEach(function (frame) {
              ...
              if (
                frame.thumb &&
                !/^[a-zA-Z]+:\/\//.test(frame.thumb) &&
                !/^data:/.test(frame.thumb)
              ) {
      ...
      },
      {
        ...
        value: function loadStream(stream) {
          ...
          if (
            stream.preview &&
            !/^[a-zA-Z]+:\/\//.test(stream.preview) &&
            !/^data:/.test(stream.preview)
          ) {
  ...
  paella.load = function (playerContainer, params) {
    ...
    initObjects.videoLoader = new paella.DefaultVideoLoader(
  ...
  paella.lazyLoad = function (playerContainer, params) {
    ...
    paella.Html5Video.IsAutoplaySupported().then(function (supported) {
      ...
      if ((supported || forceLazyLoad) && !disableUI) {
        ...
        paella.initDelegate = new paella.DefaultInitDelegate(initObjects)
        var lazyLoad = new paella.PaellaPlayerLazy(
          playerContainer,
          paella.initDelegate
        )
    ...
    _createClass(ExtendedAdapter, [
      ...
      },
      {
        ...
        value: function showTab(tabIndex) {
          ...
          var contents =
            this.bottomContainer.getElementsByClassName("tabContent")
      ...
      },
      {
        ...
        value: function addRightBarPlugin(plugin) {
          var container = document.createElement("div")
          container.className =
            "rightBarPluginContainer " + plugin.getSubclass()
...
paella.addPlugin(function () {
  var PlayButtonOnScreenAlwaysPlugin = /*#__PURE__*/ (function (
    _paella$EventDrivenPl
  ) {
      ...
      },
      {
        ...
        value: function checkStatus() {
          if (
            ...
            !paella.player.videoContainer.streamProvider.videoPlayers.every(
              function (p) {
                return p.canvasData.mouseEventsSupport
              }
            )
      ...
      },
      {
        ...
        value: function parse(content, lang, next) {
          ...
          for (var idx = 0; idx < lls.length; ++idx) {
            ...
            if (
              (/^[0-9]+$/.test(ll) || /^[0-9]+ -/.test(ll)) &&
              lls[idx - 1].trim().length === 0
            ) {
              continue
            }
    ...
    _createClass(xAPISaverPlugin, [
      ...
      },
      {
        ...
        value: function get_session_data() {
          ...
          if (ret.statements.length === 1) {
            this.played_segments =
              ret.statements[0].result.extensions[
            ...
            ADL.XAPIWrapper.lrs.registration =
              ret.statements[0].context.registration
          } else {
      ...
      },
      {
        ...
        value: function _loadDeps() {
          return new Promise(function (resolve, reject) {
            paella
              .require("resources/deps/xapiwrapper.min.js")
              .then(function () {
        ...
        value: function log(event, params) {
          ...
          switch (event) {
            ...
            case "paella:loadComplete":
              ...
              paella.player.videoContainer.duration().then(function (duration) {
                return paella.player.videoContainer.streamProvider.mainAudioPlayer
                  .volume()
                      ...
                      .then(function (quality) {
                        return paella.player.auth
                          ...
                          .then(function (user_info) {
                            ...
                            if (
                              paella.player.videoContainer.streamProvider
                                .mainAudioPlayer.stream.language
                            ) {
                              self.language =
                                paella.player.videoContainer.streamProvider.mainAudioPlayer.stream.language.replace(
                                  "_",
                                  "-"
                                )
                            }
                ...
                .then(function (currentTime) {
                  ...
                  var interacted = {
                    "https://w3id.org/xapi/video/extensions/volume":
                      self.format_float(params.master),
                  }
      ...
      },
      {
        ...
        value: function send(params) {
          ...
          var verb = new ADL.XAPIStatement.Verb(
            params.verb.id,
            params.verb.description
          )
          ...
          paella.player.videoContainer.streamProvider.mainAudioPlayer
            .volume()
            .then(function (volume) {})
          ...
          var ce_interactions = {
            "https://w3id.org/xapi/video/extensions/volume": this.format_float(
              this.volume
            ),
      ...
      },
      {
        ...
        value: function end_played_segment(end_time) {
          var arr
          arr =
            this.played_segments === "" ? [] : this.played_segments.split("[,]")
        ...
        value: function checkEnabled(onSuccess) {
          ...
          config.videoSets.forEach(function (videoSet, index) {
            ...
            if (validContent.length == 1) {
              var streamCount = 0
              paella.player.videoContainer.streamProvider.videoStreams.forEach(
                function (v) {
...
paella.addProfile(function () {
  return new Promise(function (resolve, reject) {
    paella.events.bind(paella.events.videoReady, function () {
      var available =
        paella.player.videoContainer.streamProvider.videoStreams.some(function (
          v
        ) {
    ...
    _createClass(AirPlayPlugin, [
      ...
      },
      {
        ...
        value: function checkEnabled(onSuccess) {
          ...
          if (
            paella.player.videoContainer.streamProvider.videoStreams.length != 1
          ) {
            onSuccess(false)
          } else {
      ...
      },
      {
        ...
        value: function createOverlay() {
          ...
          if (!this.arrows) {
            ...
            arrowNext.className =
              "buttonPlugin arrowSlideNavidator nextButton right icon-next2"
            this.arrows.appendChild(arrowNext)
            var arrowPrev = document.createElement("div")
            arrowPrev.className =
              "buttonPlugin arrowSlideNavidator prevButton left icon-previous2"
          ...
          if (!selectedContent) {
            ...
            var videoIndex = 0
            paella.player.videoContainer.streamProvider.streams.forEach(
              function (stream, index) {
                if (
                  stream.type == "video" &&
                  selectedContent == stream.content
                ) {
                  videoIndex = index
                }
              }
          ...
          return new Promise(function (resolve) {
            if (_this140._frames.length < 1) {
              ...
              paella.player.videoContainer
                ...
                .then(function (currentTime) {
                  if (
                    !_this140._frames.some(function (f1, i, array) {
                      if (i + 1 == array.length) {
                        return
                      }
                      ...
                      var t0 = trimming.enabled
                        ? f0.time - trimming.start
                        : f0.time
                      var t1 = trimming.enabled
                        ? f1.time - trimming.start
                        : f1.time
                      var t2 = trimming.enabled
                        ? f2.time - trimming.start
                        : f2.time
      ...
      },
      {
        ...
        value: function setup() {
          ...
          if (n.hasOwnProperty("image")) {
            ...
            self._zImages = {}
            self._zImages =
              paella.player.videoContainer.sourceData[0].sources.image[0].frames // COPY TO LOCAL

            self._videoLength =
              paella.player.videoContainer.sourceData[0].sources.image[0].duration // video duration in frames
          ...
          self._mousePos = {}
          paella.Profiles.loadProfile(
            self._blackBoardProfile,
      ...
      },
      {
        ...
        value: function createLens() {
          ...
          $(self._lensContainer).mousemove(function (event) {
            ...
            lensTop =
              lensTop > height - self._lensHeight
                ? height - self._lensHeight
                : lensTop
            var lensLeft = mouseX - self._lensWidth / 2
            lensLeft = lensLeft < 0 ? 0 : lensLeft
            lensLeft =
              lensLeft > width - self._lensWidth
                ? width - self._lensWidth
                : lensLeft
      ...
      },
      {
        ...
        value: function createOverlay() {
          ...
          if (self._currentImage) {
            ...
            $(self._blackBoardDIV).css(
              "background-image",
              "url(" + self._currentImage + ")"
            )
          }
          ...
          setTimeout(function () {
            // TIMER FOR NICE VIEW
            var overlayContainer = paella.player.videoContainer.overlayContainer
            overlayContainer.addElement(
              blackBoardDiv,
              overlayContainer.getVideoRect(0)
            )
    ...
    _createClass(BreaksPlayerPlugin, [
        ...
        value: function onEvent(eventType, params) {
          ...
          paella.player.videoContainer
            ...
            .then(function (currentTime) {
              ...
              _this144.checkBreaks(
                currentTime,
                diff >= 1 ? paella.events.seekToTime : paella.events.timeUpdate
              )
      ...
      },
      {
        ...
        value: function checkBreaks(currentTime, eventType) {
          ...
          if (
            this.breaks.some(function (breakItem) {
      ...
      },
      {
        ...
        value: function showMessage(text) {
          if (this.currentText != text) {
            ...
            this.messageContainer =
              paella.player.videoContainer.overlayContainer.addText(
                paella.utils.dictionary.translate(text),
                rect
              )
          ...
          for (var idx = 0; idx < lls.length; ++idx) {
            ...
            if (l_lang == undefined || l_lang == "") {
              if (g_lang == undefined || g_lang == "") {
                paella.log.debug(
                  "No xml:lang found! Using '" + lang + "' lang instead."
                )
                l_lang = lang
              } else {
                l_lang = g_lang
      ...
      },
      {
        ...
        value: function showUI() {
          if (paella.captions.getAvailableLangs().length >= 1) {
            _get(
              _getPrototypeOf(CaptionsPlugin.prototype),
              "showUI",
              this
            ).call(this)
          }
        ...
        value: function action() {
          ...
          switch (self._open) {
            case 0:
              if (
                self._browserLang &&
                paella.captions.getActiveCaptions() == undefined
              ) {
      ...
      },
      {
        ...
        value: function buildContent(domElement) {
          ...
          if (thisClass._searchOnCaptions) {
            ...
            thisClass._input.placeholder =
              paella.utils.dictionary.translate("Search captions")
        ...
        value: function buildBodyContent(obj, type) {
          ...
          paella.player.videoContainer.trimming().then(function (trimming) {
            ...
            obj.forEach(function (l) {
              if (
                trimming.enabled &&
                (l.end < trimming.start || l.begin > trimming.end)
              ) {
                return
              }
      ...
      _createClass(ChromaVideoCanvas, [
        ...
        },
        {
          ...
          value: function init() {
            ...
            bg.base.Loader.Load(this.gl, this.stream.src).then(function (
              texture
            ) {
    ...
    _createClass(ChromaVideo, [
        ...
        value: function _loadDeps() {
          return new Promise(function (resolve, reject) {
            if (!window.$paella_bg2e) {
              paella
                .require(paella.baseUrl + "javascript/bg2e-es2015.js")
                .then(function () {
          ...
          return new Promise(function (resolve, reject) {
            _this154._loadDeps().then(function () {
              ...
              if (
                ...
                _this154._videoQualityStrategy
              ) {
                _this154._currentQuality =
                  _this154._videoQualityStrategy.getQualityIndex(sources)
              }

              var stream =
                _this154._currentQuality < sources.length
                  ? sources[_this154._currentQuality]
                  : null
              _this154.video = null
              _this154.domElement.parentNode.style.backgroundColor =
                "transparent"

              if (stream) {
                _this154.canvasController = null
                buildChromaVideoCanvas(stream, _this154.domElement).then(
                  function (canvasController) {
                    ...
                    if (stream.crop) {
                      _this154.canvasController.crop = new bg.Vector4(
                        stream.crop.left,
                        stream.crop.top,
                        stream.crop.right,
                        stream.crop.bottom
                    ...
                    if (stream.displacement) {
                      _this154.canvasController.transform =
                        bg.Matrix4.Translation(
                          stream.displacement.x,
                          stream.displacement.y,
                          0
                        )
                    }

                    if (stream.chromaColor) {
                      _this154.canvasController.chroma = new bg.Color(
                        stream.chromaColor[0],
      ...
      },
      {
        ...
        value: function getCurrentQuality() {
          ...
          return new Promise(function (resolve) {
            resolve(
              _this157._getQualityObject(
                _this157._currentQuality,
                _this157._stream.sources[_this157._streamName][
                  _this157._currentQuality
                ]
              )
            )
      ...
      },
      {
        ...
        value: function onTimeUpdate() {
          ...
          paella.player.videoContainer
            ...
            .then(function (trimming) {
              var videoCurrentTime = Math.round(
                currentTime + (trimming.enabled ? trimming.start : 0)
              )

              if (
                _this170.inPosition <= videoCurrentTime &&
                videoCurrentTime <=
                  _this170.inPosition + _this170.INTERVAL_LENGTH
              ) {
                _this170.outPosition = videoCurrentTime

                if (
                  _this170.inPosition + _this170.INTERVAL_LENGTH ===
                  _this170.outPosition
                ) {
                  _this170.trackFootPrint(
                    _this170.inPosition,
                    _this170.outPosition
                  )
    ...
    _createClass(FrameControlPlugin, [
      ...
      },
      {
        ...
        value: function checkEnabled(onSuccess) {
          ...
          if (paella.initDelegate.initParams.videoLoader.frameList == null)
            ...
            paella.initDelegate.initParams.videoLoader.frameList.length === 0
          )
            onSuccess(false)
          else if (
            Object.keys(paella.initDelegate.initParams.videoLoader.frameList)
            ...
            if (thisClass.isPopUpOpen()) {
              if (event.keyCode == Keys.Left) {
                if (selectedItem > 0) {
                  ...
                  jumpAtItem =
                    visibleItems * (blockCounter - 1) - 1 - correctJump

                  if (selectedItem == jumpAtItem && selectedItem != 0) {
                    thisClass.navButtons.left.scrollContainer.scrollLeft -=
                      visibleItems * 105
                    --blockCounter
                  }
                  ...
                  if (!paella.utils.userAgent.browser.IsMobileVersion) {
                    thisClass.buttons[selectedItem].frameControl.onMouseOver(
                      null,
                      thisClass.buttons[selectedItem].frameData
                    )
                  }

                  oldClassName = thisClass.buttons[selectedItem].className
                  thisClass.buttons[selectedItem].className =
                ...
                thisClass.buttons[selectedItem].frameControl.onClick(
                  null,
                  thisClass.buttons[selectedItem].frameData
                )
      ...
      },
      {
        ...
        value: function buildContent(domElement) {
          ...
          $(window).mousemove(function (event) {
            if (
              $(content).offset().top > event.pageY ||
              !$(content).is(":visible") ||
          ...
          paella.events.bind(paella.events.setTrim, function (event, params) {
            _this171.updateFrameVisibility(
              params.trimEnabled,
              params.trimStart,
              params.trimEnd
            )
          ...
          switch (this._showFullPreview) {
            case "auto":
              ...
              if (streams.length == 1) {
                ...
                overlayContainer.addElement(
                  frameRoot,
                  overlayContainer.getVideoRect(1)
                )
              }
            ...
            for (i = 0; i < this.frames.length; ++i) {
              ...
              if (frameData.time < trimStart) {
                if (
                  ...
                  this.frames[i + 1].frameData.time > trimStart
                ) {
                  $(frameElem).show()
                } else {
                  $(frameElem).hide()
      ...
      },
      {
        ...
        value: function onClick(event, frameData) {
          paella.player.videoContainer.trimming().then(function (trimming) {
            var time = trimming.enabled
              ? frameData.time - trimming.start
              : frameData.time
        ...
        value: function onTimeUpdate(currentTime) {
          ...
          paella.player.videoContainer.trimming().then(function (trimming) {
            ...
            for (var i = 0; i < _this173.frames.length; ++i) {
              if (
                _this173.frames[i].frameData &&
                _this173.frames[i].frameData.time <= time
              ) {
            ...
            if (_this173.currentFrame != frame && frame) {
              ...
              if (_this173.currentFrame)
                _this173.currentFrame.className = "frameControlItem"
          ...
          if (
            ...
            setTimeout(function () {
              if (_this175._reload) {
                paella.player.videoContainer
                  .setQuality(null)
                  .then(function () {}) //paella.player.reloadVideos();
              }
            }, 1000)
          }
        },
  ...
  return /*#__PURE__*/ (function (_paella$ButtonPlugin10) {
    ...
    _createClass(HelpPlugin, [
      ...
      },
      {
        ...
        value: function getDefaultToolTip() {
          return (
            paella.utils.dictionary.translate("Show help") +
            " (" +
    ...
    _createClass(HLSPlayer, [
        ...
        value: function _loadDeps() {
          return new Promise(function (resolve, reject) {
            if (!window.$paella_hls) {
              paella
                .require(paella.baseUrl + "javascript/hls.min.js")
                .then(function (hls) {
      ...
      },
      {
        ...
        value: function setupHls(video, url) {
          ...
          var initialQualityLevel =
            this.config.initialQualityLevel !== undefined
              ? this.config.initialQualityLevel
              : 1
          return new Promise(function (resolve, reject) {
              ...
              if (Hls.isSupported()) {
                ...
                _this177._hls.on(
                  ...
                  function (ev, data) {
                    ...
                    _this177._qualityIndex = _this177.autoQuality
                      ? _this177._qualities.length - 1
                      : data.level
                    paella.events.trigger(paella.events.qualityChanged, {})
                    if (console && console.log)
                      console.log(
                        "HLS: quality level changed to ".concat(data.level)
                      )
                  }
                )
                    ...
                    switch (data.type) {
                      case Hls.ErrorTypes.NETWORK_ERROR:
                        if (
                          ...
                          console.error(
                            "paella.HLSPlayer: unrecoverable error in HLS Player. The video is not available."
                          )
                          reject(
                            new Error(
                              "No such HLS stream: the video is not available"
                            )
                          )
                        } else {
                          console.error(
                ...
                _this177._hls.on(Hls.Events.MANIFEST_PARSED, function () {
                  ...
                  _this177._hls.currentLevel =
                    _this177._hls.levels.length >= initialQualityLevel
                      ? initialQualityLevel
                      : -1
                  setTimeout(function () {
      ...
      },
      {
        ...
        value: function webGlDidLoad() {
          ...
          if (paella.utils.userAgent.system.iOS) {
            return _get(
              _getPrototypeOf(HLSPlayer.prototype),
              "webGlDidLoad",
              this
            ).call(this)
          ...
          bg.utils.HTTPResourceProvider.AddVideoLoader(
            "m3u8",
        ...
        value: function loadVideoStream(canvasInstance, stream) {
          ...
          if (paella.utils.userAgent.system.iOS) {
            return _get(
              ...
              "loadVideoStream",
              this
            ).call(this, canvasInstance, stream)
          }
        ...
        value: function setCurrentAudioTrack(trackId) {
          ...
          return this._deferredAction(function () {
            if (paella.utils.userAgent.system.iOS) {
              ...
              if (
                _this182._hls.audioTracks.some(function (track) {
            ...
            return new Promise(function (resolve) {
              if (!_this184._qualities || _this184._qualities.length == 0) {
                ...
                _This._hls.levels.forEach(function (q, index) {
                  _This._qualities.push(
                    _This._getQualityObject(index, {
                      index: index,
                      res: {
                        w: q.width,
                        h: q.height,
                ...
                if (_this184._qualities.length > 1) {
                  ...
                  _This._qualities.push(
                    _This._getQualityObject(_This._qualities.length, {
      ...
      },
      {
        ...
        value: function enable(isMainAudioPlayer) {
          if (
            this._currentQualityIndex !== undefined &&
  ...
  return /*#__PURE__*/ (function (_paella$VideoOverlayB2) {
    ...
    _createClass(LiveStreamIndicator, [
      ...
      },
      {
        key: "getDefaultToolTip",
        value: function getDefaultToolTip() {
          return paella.utils.dictionary.translate(
            "This video is a live stream"
          )
        },
      },
      {
    ...
    _createClass(MpegDashVideo, [
        ...
        value: function _loadDeps() {
          return new Promise(function (resolve, reject) {
            if (!window.$paella_mpd) {
              paella
                .require(paella.baseUrl + "resources/deps/dash.all.js")
                .then(function () {
      ...
      },
      {
        ...
        value: function _getQualityObject(item, index, bitrates) {
          ...
          var label =
            index == 0 ? "min" : index == total - 1 ? "max" : percent + "%"
          return {
            index: index,
            res: {
              w: null,
                ...
                _this190._player
                  ...
                  .forEach(function (item, index, bitrates) {
                    _this190._qualities.push(
                      _this190._getQualityObject(item, index, bitrates)
                    )
                  })
        ...
        value: function getCurrentQuality() {
          ...
          return new Promise(function (resolve, reject) {
            if (_this192._player.getAutoSwitchQuality()) {
              ...
              resolve(
                _this192._getQualityObject(
                  _this192._qualities[index],
                  index,
                  _this192._player.getBitrateInfoListFor("video")
                )
              )
            }
          })
  ...
  var MpegDashVideoFactory = /*#__PURE__*/ (function (_paella$VideoFactory4) {
    ...
    _createClass(MpegDashVideoFactory, [
      ...
      },
      {
        ...
        value: function getVideoObject(id, streamData, rect) {
          ++paella.videoFactories.Html5VideoFactory.s_instances
          return new paella.MpegDashVideo(
            id,
            streamData,
            rect.x,
            rect.y,
...
paella.addPlugin(function () {
  return /*#__PURE__*/ (function (_paella$ButtonPlugin13) {
    _inherits(PlaybackRate, _paella$ButtonPlugin13)
    ...
    _createClass(PlaybackRate, [
      ...
      },
      {
        ...
        value: function checkEnabled(onSuccess) {
          ...
          var enabled =
            paella.player.videoContainer.masterVideo() instanceof
            paella.Html5Video
          onSuccess(
            enabled &&
              !paella.player.videoContainer.streamProvider.isLiveStreaming
          )
        },
      },
      {
      ...
      },
      {
        ...
        value: function getButtonItemClass(profileName, selected) {
          return (
            "playbackRateItem " + profileName + (selected ? " selected" : "")
          )
        },
      },
    ])
        ...
        value: function endVideo() {
          ...
          paella.player.videoContainer.ended().then(function (ended) {
            if (ended) {
              ...
              base.log.debug(
                "BTN ON SCREEN: The player is no longer in ended state."
              )
            }
          })
        },
        ...
        value: function updateHeader() {
          ...
          if (this.count > 0) {
            ...
            score += " "
              .concat(this.score, " ")
              .concat(this.count, " ")
              .concat(paella.utils.dictionary.translate("votes"))
          }

          this.scoreContainer.header.innerHTML = "\n\t\t\t<div>\n\t\t\t\t<h4>"
            .concat(
              paella.utils.dictionary.translate("Video score"),
              ":</h4>\n\t\t\t\t<h5>\n\t\t\t\t\t"
            )
            .concat(score, "\n\t\t\t\t</h5>\n\t\t\t\t</h4>\n\t\t\t\t<h4>")
            .concat(
              paella.utils.dictionary.translate("Vote:"),
              "</h4>\n\t\t\t</div>\n\t\t\t"
            )
        },
      },
      {
        ...
        value: function updateRateButtons() {
          ...
          if (this.canVote) {
            ...
            this.scoreContainer.rateButtons.innerHTML = "<h5>".concat(
              paella.utils.dictionary.translate("Login to vote"),
              "</h5>"
            )
          }
        ...
        value: function checkEnabled(onSuccess) {
          ...
          paella.data.read(
            ...
            function (data) {
              ...
              onSuccess(
                Array.isArray(_this208._relatedVideos) &&
                  _this208._relatedVideos.length > 0
              )
            }
          )
        },
        ...
        value: function showRelatedVideos() {
          ...
          switch (this._relatedVideos.length) {
            ...
            default:
              ...
              container.appendChild(
                getRelatedVideoLink(
                  this._relatedVideos[1],
                  "related-video-dual-2"
                )
              )
              break
          }
        ...
        if (eventName == "progress") {
          ...
          paella.log.debug(
            "Flash video event: " +
              eventName +
              ", progress: " +
              This.flashVideo.currentProgress()
          )
    ...
    _createClass(RTMPVideo, [
            ...
            swfobject.embedSWF(
              ...
              function callbackFn(e) {
                if (e.success == false) {
                  ...
                  header.innerText = paella.utils.dictionary.translate(
        ...
        value: function _deferredAction(action) {
          ...
          return new Promise(function (resolve, reject) {
            if (_this210.ready) {
              ...
              $(_this210.swfContainer).bind(
                "paella:flashvideoready",
                function () {
        ...
        value: function load() {
          ...
          if (stream) {
            if (!isValid(stream)) {
              ...
              if (
                stream.src.requiresSubscription === undefined &&
              ...
              parameters.isLiveStream =
                stream.isLiveStream !== undefined ? stream.isLiveStream : false
      ...
      },
      {
        ...
        value: function getCurrentQuality() {
          ...
          return new Promise(function (resolve, reject) {
            resolve(
              _this214._getQualityObject(
                _this214._currentQuality,
                _this214._stream.sources.rtmp[_this214._currentQuality]
              )
            )
          })
        },
        ...
        value: function play() {
          ...
          return this._deferredAction(function () {
            if (This._posterFrameElement) {
              This._posterFrameElement.parentNode.removeChild(
                This._posterFrameElement
              )
    ...
    _createClass(SearchPlugin, [
      ...
      },
      {
        ...
        value: function setup() {
          ...
          self._localImages =
            paella.initDelegate.initParams.videoLoader.frameList //config
      ...
      },
      {
        ...
        value: function createLoadingElement(parent) {
          ...
          sBodyText.innerText =
            paella.utils.dictionary.translate("Searching") + "..."
      ...
      },
      {
        ...
        value: function createNotResultsFound(parent) {
          ...
          noResults.innerText = paella.utils.dictionary.translate(
            ...
            if (!err) {
              if (results.length == 0) {
                ...
                for (var i = 0; i < results.length; i++) {
                  ...
                  if (
                    thisClass._trimming.enabled &&
                    results[i].time <= thisClass._trimming.start
                  ) {
                    continue
                  ...
                  var sBodyText = document.createElement("p")
                  sBodyText.className = "sBodyText"
                  var time = thisClass._trimming.enabled
                    ? results[i].time - thisClass._trimming.start
                    : results[i].time
                  sBodyText.innerHTML =
                    "<span class='timeSpan'>" +
                    thisClass.prettyTime(time) +
                    "</span>" +
                    paella.AntiXSS.htmlEscape(results[i].content)
        ...
        value: function buildContent(domElement) {
          ...
          $(input).keyup(function (event) {
            if (event.keyCode != 13) {
              ...
              if (text != "") {
                thisClass._searchTimer = new paella.utils.Timer(function (
                  timer
                ) {
                  thisClass.doSearch(text, searchBody)
                },
    ...
    _createClass(SharePlugin, [
      ...
      },
      {
        ...
        value: function buildEmbed() {
          ...
          embed.innerHTML =
            '\n\t\t\t\t<div>\n\t\t\t\t\t<div class="form-group">\n\t\t\t\t\t\t<label class="control-label">\n\t\t\t\t\t\t\t<input id="share-video-responsive" type="checkbox" value="3" name="mailId[]" > '
              .concat(
                paella.utils.dictionary.translate("Responsive design"),
                '\n\t\t\t\t\t\t</label>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div id="share-video-block-size" class="form-group">\n\t\t\t\t\t\t<label class="control-label"> '
              )
              .concat(
                paella.utils.dictionary.translate("Video resolution"),
              ...
              .concat(
                paella.utils.dictionary.translate("Custom size"),
              ...
              .concat(
                paella.utils.dictionary.translate("Embed code"),
                '</label>\n\t\t\t\t\t\t\n\t\t\t\t\t\t<div id="share-video-embed" class="alert alert-share">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t'
              )

          embed.querySelector("#share-video-responsive").onchange = function (
            event
          ) {
            var responsive = self._domElement.querySelector(
              "#share-video-responsive"
            ).checked

            if (responsive) {
              self._domElement.querySelector(
                "#share-video-block-resp"
              ).style.display = "block"
              self._domElement.querySelector(
                "#share-video-block-size"
              ).style.display = "none"
            } else {
              self._domElement.querySelector(
                "#share-video-block-resp"
          ...
          embed.querySelector("#share-video-size-resp").onchange = function (
            event
          ) {
            self.updateEmbedCode()
          }

          embed.querySelector("#share-video-width").onchange = function (
            event
          ) {
            self.updateEmbedCode()
          }

          embed.querySelector("#share-video-height").onchange = function (
            event
          ) {
            self.updateEmbedCode()
          }
      ...
      },
      {
        ...
        value: function buildSocial() {
          ...
          social.innerHTML =
            '\n\t\t\t\t<div>\n\t\t\t\t\t<div class="form-group">\n\t\t\t\t\t\t<label class="control-label">'.concat(
              paella.utils.dictionary.translate("Share on social networks"),
          ...
          social.querySelector("#share-btn-facebook").onclick = function (
            event
          ) {
            self.onSocialClick("facebook")
          }

          social.querySelector("#share-btn-twitter").onclick = function (
            event
          ) {
            self.onSocialClick("twitter")
          }

          social.querySelector("#share-btn-linkedin").onclick = function (
            event
          ) {
          ...
          switch (network) {
            case "twitter":
              shareUrl = "http://twitter.com/share?url="
                .concat(videoUrl, "&text=")
                .concat(title)
              break

            case "facebook":
              shareUrl = "http://www.facebook.com/sharer.php?u="
                .concat(videoUrl, "&p[title]=")
                .concat(title)
              break

            case "linkedin":
              shareUrl = "https://www.linkedin.com/shareArticle?mini=true&url="
                .concat(videoUrl, "&title=")
                .concat(title)
              break
          }
      ...
      },
      {
        ...
        value: function updateEmbedCode() {
          ...
          var responsive = this._domElement.querySelector(
            "#share-video-responsive"
          ).checked

          var width = this._domElement.querySelector("#share-video-width").value

          var height = this._domElement.querySelector(
            "#share-video-height"
          ).value

          var respSize = this._domElement.querySelector(
            "#share-video-size-resp"
          ).value

          var embedCode = ""

          if (responsive) {
            embedCode = '<div style="width:'
              .concat(
                respSize,
                '%"><div style="position:relative;display:block;height:0;padding:0;overflow:hidden;padding-bottom:56.25%"> <iframe allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" src="'
              )
              .concat(
                videoUrl,
                '" style="border:0px #FFFFFF none; position:absolute; width:100%; height:100%" name="Paella Player" scrolling="no" frameborder="0" marginheight="0px" marginwidth="0px" width="100%" height="100%"></iframe> </div></div>'
              )
          } else {
            embedCode =
              '<iframe allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" src="'
                .concat(
                  videoUrl,
                  '" style="border:0px #FFFFFF none;" name="Paella Player" scrolling="no" frameborder="0" marginheight="0px" marginwidth="0px" width="'
                )
                .concat(width, '" height="')
                .concat(height, '"></iframe>')
          }

          this._domElement.querySelector("#share-video-embed").innerText =
            embedCode
        },
      },
    ])
  ...
  return /*#__PURE__*/ (function (_paella$VideoOverlayB3) {
    ...
    _createClass(ShowEditorPlugin, [
      ...
      },
      {
        ...
        value: function checkEnabled(onSuccess) {
          if (this.config.editorUrl) {
            paella.initDelegate.initParams.accessControl
              .canWrite()
      ...
      },
      {
        key: "action",
        value: function action(button) {
          var editorUrl = this.config.editorUrl.replace(
            "{id}",
        ...
        value: function drawCanvas(context, width, height, videoData) {
          ...
          if (this._hasSlides) {
            this._frameKeys.forEach(function (l) {
              l = parseInt(l)
              var timeInstant = videoData.trimming.enabled
                ? l - videoData.trimming.start
                : l

              if (
                timeInstant > 0 &&
                timeInstant < videoData.trimming.duration
              ) {
...
;(function () {
  ...
  function updatePosition(positionData, nextFrameData) {
    var twinTime = nextFrameData
      ? (nextFrameData.time - positionData.time) * 1000
      : 100
    ...
    paella.player.videoContainer
      .masterVideo()
      .setZoom(zoom * 100, left * zoom * 100, top * zoom * 100, twinTime)
  }
    ...
    return /*#__PURE__*/ (function (_paella$ButtonPlugin19) {
      ...
      _createClass(VideoZoomTrack4KPlugin, [
        ...
        },
        {
          ...
          value: function checkEnabled(onSuccess) {
            var players =
              paella.player.videoContainer.streamProvider.videoPlayers
            ...
            this.targetPlayer =
              players.length > playerIndex ? players[playerIndex] : null
          ...
          value: function buildContent(domElement) {
            ...
            function getZoomButton(className, onClick, content) {
              ...
              if (content) {
                ...
                btn.innerHTML = '<i class="glyphicon glyphicon-'.concat(
                  className,
                  '"></i>'
                )
              }
            ...
            domElement.appendChild(
              getZoomButton("zoom-in", function (evt) {
                _this218.zoomIn()
              })
            )
            domElement.appendChild(
              getZoomButton("zoom-out", function (evt) {
                _this218.zoomOut()
              })
            )
            domElement.appendChild(
              getZoomButton("picture", function (evt) {
                _this218.resetZoom()
              })
            )
            domElement.appendChild(
...
paella.addPlugin(function () {
  return /*#__PURE__*/ (function (_paella$EventDrivenPl12) {
    _inherits(TrimmingLoaderPlugin, _paella$EventDrivenPl12)

    var _super105 = _createSuper(TrimmingLoaderPlugin)
          ...
          paella.player.videoContainer
            ...
            .then(function (paused) {
              var log = {
                ...
                playing: !paused,
                time: parseInt(
                  currentTime + paella.player.videoContainer.trimStart()
                ),
                event: event,
                params: p,
              }
  ...
  return /*#__PURE__*/ (function (_paella$userTracking$3) {
    ...
    _createClass(GoogleAnalyticsTracking, [
      ...
      },
      {
        ...
        value: function log(event, params) {
          if (
            this.config.category === undefined ||
    ...
    _createClass(VideoDataPlugin, [
      ...
      },
      {
        ...
        value: function checkEnabled(onSuccess) {
          // Check if enabled
          var plugin =
            paella.player.config.plugins.list["es.upv.paella.videoDataPlugin"]
          ...
          if (window != window.parent) {
            excluded =
              excluded ||
              excludeParent.some(function (url) {
                var re = RegExp(url, "i")
      ...
      },
      {
        ...
        value: function setup() {
          ...
          function checkVisibility() {
            ...
            var showButtons =
              this.config.showButtons !== undefined
              ...
              _this222._thumbnails.some(function (thumb) {
                if (thumb.player == target.video) {
                  if (thumb.player.zoom > 100) {
                    ...
                    var x =
                      (target.video.zoomOffset.x * 100) / target.video.zoom
                    var y =
                      (target.video.zoomOffset.y * 100) / target.video.zoom
    ...
    _createClass(ViewModePlugin, [
              ...
              if (event.keyCode == Keys.Up) {
                if (thisClass.selected_button > 0) {
                  if (thisClass.selected_button < thisClass.buttons.length)
                    thisClass.buttons[thisClass.selected_button].className =
                      "viewModeItemButton " +
                      thisClass.buttons[thisClass.selected_button].data.profile
                ...
                thisClass.onItemClick(
                  thisClass.buttons[thisClass.selected_button],
                  thisClass.buttons[thisClass.selected_button].data.profile,
                  thisClass.buttons[thisClass.selected_button].data.profile
                )
              }
      ...
      },
      {
        ...
        value: function getButtonItemIcon(profileData) {
          return ""
            .concat(paella.baseUrl, "resources/style/")
            .concat(profileData.icon)
        },
      },
    ])
    ...
    _createClass(VolumeRangePlugin, [
      ...
      },
      {
        ...
        value: function getExpandableContent() {
          ...
          paella.player.videoContainer.audioPlayer
            .volume()
            .then(function (vol) {
  ...
  var YoutubeVideoFactory = /*#__PURE__*/ (function (_paella$VideoFactory7) {
    ...
    _createClass(YoutubeVideoFactory, [
      ...
      },
      {
        ...
        value: function getVideoObject(id, streamData, rect) {
          this.initYoutubeApi()
          return new paella.YoutubeVideo(
            id,
            streamData,
            rect.x,
            rect.y,
          ...
          if (server && site_id) {
            ...
            paella.require(server + "piwik.js").then(function (matomo) {
              ...
              paella.userTracking.matomotracker.client_id =
                thisClass.config.client_id
              if (heartbeat && heartbeat > 0)
                paella.userTracking.matomotracker.enableHeartBeatTimer(
                  heartbeat
                )
    ...
    _createClass(X5gonTracking, [
      ...
      },
      {
        ...
        value: function checkEnabled(onSuccess) {
          ...
          function trackX5gon() {
            paella.log.debug(
              "X5GON: trackX5gon permission check [trackingPermission " +
                trackingPermission +
                "] [tracked " +
                tracked +
                "]"
            ...
            if (isTrackingPermission() && !tracked) {
              if (!token) {
                ...
                paella.log.debug(
                  "X5GON: trackX5gon loading x5gon-snippet, token: " + token
                )
            ...
            paella.require(urlCookieconsentJS).then(function (cookieconsent) {
              ...
              window.cookieconsent.initialise({
                ...
                content: {
                  message: translate(
                    "x5_message",
                    "On this site the X5gon service can be included, to provide personalized Open Educational Ressources."
                  ),
          ...
          function initTranslate(language, funcSuccess, funcError) {
            paella.log.debug(
              "X5GON: selecting language " + language.slice(0, 2)
            )
            var jsonstr =
              window.location.origin +
              "/player/localization/paella_" +
              language.slice(0, 2) +
              ".json"
            $.ajax({
              url: jsonstr,
          ...
          function translate(str, strIfNotFound) {
            return translations[str] != undefined
              ? translations[str]
              : strIfNotFound
          }
